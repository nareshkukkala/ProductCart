...
class SideMenuViewController: UIViewController {
    ...
    var menu: [SideMenuModel] = [
        ...
        SideMenuModel(icon: UIImage(systemName: "music.note")!, title: "All Matches"),
        SideMenuModel(icon: UIImage(systemName: "film.fill")!, title: "Saved Matches"),
    ]
    ...
    override func viewDidLoad() {
        ...
        self.footerLabel.text = "Developed by Naresh Kukkala"
